...
outfile = open('sale_json.pdf', 'wb')
outfile.write(base64.b64decode(res[0]))
outfile.close()



connection = get_connection(hostname="localhost", database='report', port=8069, login='admin', password='admin', protocol='xmlrpc')
